...
<body>
	...
	<div class="container pt-2" id="conversionResult">
		<h2>Results</h2>
		<p>Number: <%= (request.getAttribute("number") != null) ? request.getAttribute("number") : "Enter a number" %></p>
		<p>Result: <%= (request.getAttribute("converted") != null) ? request.getAttribute("converted") : "Conversion result" %></p>
		<p><%= (request.getAttribute("message") != null) ? request.getAttribute("message") : "Message" %></p>
	</div>
